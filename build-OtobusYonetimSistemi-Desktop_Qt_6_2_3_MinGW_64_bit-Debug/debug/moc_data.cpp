...
#include <memory>
#include "../../OtobusYonetimSistemi/Veri/data.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Data_t, stringdata0) + ofs), len 
...
const QMetaObject Data::staticMetaObject = { {
    ...
    qt_meta_stringdata_Data.offsetsAndSize,
    qt_meta_data_Data,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Data_t
